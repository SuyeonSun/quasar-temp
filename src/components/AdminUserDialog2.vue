      ...
      <table style="width: 100%;">
        ...
        <tr>
          ...
          <td class="text-center">
            <AdminUserDialogCheckbox v-model="evStation.read.permission" :is-disable="evStation.read.isDisable" />
          </td>
          <td class="text-center">
            <AdminUserDialogCheckbox v-model="evStation.update.permission" :is-disable="evStation.update.isDisable" />
          </td>
          <td class="text-center">
            <AdminUserDialogCheckbox v-model="evStation.delete.permission" :is-disable="evStation.delete.isDisable" />
          </td>
          <td class="text-center">
            <AdminUserDialogCheckbox v-model="evStation.write.permission" :is-disable="evStation.write.isDisable" />
          </td>
        </tr>
