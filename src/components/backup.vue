...
onMounted(async () => {
  ...
  const mouseOver = function (d) {
    ...
    d3.select(this)
      ...
      .style("stroke", "white");
    tooltip
      .style("left", event.pageX + 15 + "px") // x좌표 위치 반환
  ...
  // Legend
  // TODO: 추후 수정 필요
  // 참고: https://d3-legend.susielu.com/
  // 참고: https://bl.ocks.org/HarryStevens/6eb89487fc99ad016723b901cbd57fde
